...
/// method.
template <typename IM> class UnionFind {
public:
  ///\e
...
/// method.
///
template <typename IM> class UnionFindEnum {
public:
  ///\e
  typedef IM ItemIntMap;
  ///\e
...
public:
  UnionFindEnum(ItemIntMap &_index)
      : index(_index), items(), firstFreeItem(-1), firstClass(-1),
        firstFreeClass(-1) {}
...
/// \pre You need to add all the elements by the \ref insert()
/// method.
template <typename IM> class ExtendFindEnum {
public:
  ///\e
  typedef IM ItemIntMap;
  ///\e
...
public:
  ...
  ExtendFindEnum(ItemIntMap &_index)
      : index(_index), items(), firstFreeItem(-1), classes(), firstClass(-1),
        firstFreeClass(-1) {}
...
public:
  ...
  HeapUnionFind(ItemIntMap &_index)
      : index(_index), first_class(-1), first_free_class(-1),
        first_free_node(-1) {}
  ...
  template <typename Iterator> int join(Iterator begin, Iterator end) {
    std::vector<int> cs;
  ...
  /// classes.
  template <typename Iterator> void split(int cls, Iterator out) {
    std::vector<int> cs;
