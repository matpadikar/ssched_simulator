...
template <typename _Digraph, typename _PredMap> class PredMapPath {
public:
...
template <typename _Digraph, typename _PredMatrixMap> class PredMatrixMapPath {
public:
  typedef True RevPathTag;
  ...
  PredMatrixMapPath(const Digraph &_digraph,
                    ...
                    typename Digraph::Node _target)
      : digraph(_digraph), predMatrixMap(_predMatrixMap), source(_source),
        target(_target) {}
