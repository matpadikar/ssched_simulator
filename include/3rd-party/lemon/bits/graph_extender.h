...
template <typename Base> class DigraphExtender : public Base {
  typedef Base Parent;
...
template <typename Base> class GraphExtender : public Base {
  typedef Base Parent;
...
template <typename Base> class BpGraphExtender : public Base {
  typedef Base Parent;
...
public:
  ...
  private:
    ...
    template <typename CMap> RedNodeMap &operator=(const CMap &cmap) {
      Parent::operator=(cmap);
      return *this;
    }
  };
  ...
  private:
    ...
    template <typename CMap> BlueNodeMap &operator=(const CMap &cmap) {
      Parent::operator=(cmap);
      return *this;
    }
  };
