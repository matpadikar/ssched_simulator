...
template <typename _Map> class MapExtender : public _Map {
  typedef _Map Parent;
...
private:
  ...
  template <typename CMap> MapExtender &operator=(const CMap &cmap) {
...
template <typename _Graph, typename _Map> class SubMapExtender : public _Map {
  typedef _Map Parent;
...
private:
  ...
  template <typename CMap> SubMapExtender &operator=(const CMap &cmap) {
