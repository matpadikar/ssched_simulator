...
template <typename Sequence> struct PairComp {
...
template <typename In, typename Enable = void> struct SequenceInputIndicator {
  static const bool value = false;
};

template <typename In>
struct SequenceInputIndicator<
    In, typename exists<typename In::value_type::first_type>::type> {
  static const bool value = true;
};

template <typename In, typename Enable = void> struct MapInputIndicator {
  static const bool value = false;
};
...
template <typename In, typename Enable = void> struct SequenceOutputIndicator {
  static const bool value = false;
};

template <typename Out>
struct SequenceOutputIndicator<
    Out, typename exists<typename Out::value_type>::type> {
  static const bool value = true;
};

template <typename Out, typename Enable = void> struct MapOutputIndicator {
  static const bool value = false;
};
...
template <typename In, typename InEnable = void> struct KruskalValueSelector {};

template <typename In>
struct KruskalValueSelector<
    In, typename enable_if<SequenceInputIndicator<In>, void>::type> {
  typedef typename In::value_type::second_type Value;
};

template <typename In>
struct KruskalValueSelector<
    In, typename enable_if<MapInputIndicator<In>, void>::type> {
...
template <typename Graph, typename In, typename Out>
struct KruskalInputSelector<
    Graph, In, Out, typename enable_if<MapInputIndicator<In>, void>::type> {
  typedef typename In::Value Value;
  static Value kruskal(const Graph &graph, const In &in, Out &out) {
    ...
    return KruskalOutputSelector<Graph, Sequence, Out>::kruskal(graph, seq,
                                                                out);
  }
};
...
template <typename Graph, typename In, typename Out>
struct KruskalOutputSelector<
    Graph, In, Out, typename enable_if<MapOutputIndicator<Out>, void>::type> {
  typedef typename In::value_type::second_type Value;
...
#endif
{
  return _kruskal_bits::KruskalInputSelector<Graph, In, Out>::kruskal(graph, in,
                                                                      out);
}
