...
protected:
  ...
  public:
    ...
    bool self_delete;
    ParData()
        : mandatory(false), type(UNKNOWN), set(false), ingroup(false),
...
private:
  ...
  ArgParser &funcOption(const std::string &name, const std::string &help,
...
public:
  ...
  ArgParser &intOption(const std::string &name, const std::string &help,
  ...
  ///\param value A default value for the option.
  ///\param obl Indicate if the option is mandatory.
  ArgParser &doubleOption(const std::string &name, const std::string &help,
  ...
  ArgParser &boolOption(const std::string &name, const std::string &help,
  ...
  ///\param value A default value for the option.
  ///\param obl Indicate if the option is mandatory.
  ArgParser &stringOption(const std::string &name, const std::string &help,
  ...
  ArgParser &refOption(const std::string &name, const std::string &help,
