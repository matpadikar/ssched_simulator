...
public:
  ...
  template <typename _GraphItem> struct Constraints {
    void constraints() {
      _GraphItem i1;
      i1 = INVALID;
      _GraphItem i2 = i1;
...
public:
  ...
  template <typename _Digraph> struct Constraints {
...
public:
  ...
  template <typename _Graph> struct Constraints {
...
public:
  ...
  template <typename _BpGraph> struct Constraints {
...
template <typename GR, typename Item> class GraphItemIt : public Item {
public:
  /// \brief Default constructor.
  ///
  /// Default constructor.
  ...
  template <typename _GraphItemIt> struct Constraints {
    void constraints() {
...
template <typename GR, typename Item = typename GR::Arc,
          typename Base = typename GR::Node, char sel = '0'>
...
public:
  ...
  template <typename _GraphIncIt> struct Constraints {
    void constraints() {
    ...
    void constraints() {
...

      {
        ...
        checkConcept<GraphIncIt<_Digraph, typename _Digraph::Arc,
                                typename _Digraph::Node, 'i'>,
                     typename _Digraph::InArcIt>();
        checkConcept<GraphIncIt<_Digraph, typename _Digraph::Arc,
                                typename _Digraph::Node, 'o'>,
...
private:
  ...
  template <typename CMap> GraphMap &operator=(const CMap &) {
    checkConcept<ReadMap<Key, Value>, CMap>();
    return *this;
  }

public:
  template <typename _Map> struct Constraints {
    void constraints() {
...
public:
  ...
  private:
    ...
    ///
    /// Assignment operator.
    template <typename CMap> NodeMap &operator=(const CMap &) {
  ...
  private:
    ...
    ///
    /// Assignment operator.
    template <typename CMap> ArcMap &operator=(const CMap &) {
...
public:
  ...
  private:
    ...
    ///
    /// Assignment operator.
    template <typename CMap> RedNodeMap &operator=(const CMap &) {
      checkConcept<ReadMap<Node, V>, CMap>();
      return *this;
    }
  };
  ...
  private:
    ...
    ///
    /// Assignment operator.
    template <typename CMap> BlueNodeMap &operator=(const CMap &) {
      checkConcept<ReadMap<Node, V>, CMap>();
      return *this;
    }
  };
