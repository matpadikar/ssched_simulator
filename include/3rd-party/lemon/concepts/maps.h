...
/// Readable map concept.
///
template <typename K, typename T> class ReadMap {
public:
  ...
  template <typename _ReadMap> struct Constraints {
    void constraints() {
      Value val = m[key];
      val = m[key];
...
/// Writable map concept.
///
template <typename K, typename T> class WriteMap {
public:
  /// The key type of the map.
  typedef K Key;
  /// \brief The value type of the map.
  ...
  template <typename _WriteMap> struct Constraints {
    void constraints() {
      m.set(key, val);
...
public:
  ...
  template <typename _ReadWriteMap> struct Constraints {
    void constraints() {
...
public:
  ...
  template <typename _ReferenceMap> struct Constraints {
