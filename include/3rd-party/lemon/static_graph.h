...
public:
  StaticDigraphBase()
      : built(false), node_num(0), arc_num(0), node_first_out(NULL),
        node_first_in(NULL), arc_source(NULL), arc_target(NULL),
...
private:
  template <typename Digraph, typename NodeRefMap> class ArcLess {
  public:
