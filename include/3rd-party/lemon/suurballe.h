...
private:
  ...
  public:
    ...
    ResidualDijkstra(Suurballe &srb)
        : _graph(srb._graph), _length(srb._length), _flow(*srb._flow),
          _pi(*srb._potential), _pred(srb._pred), _s(srb._s), _t(srb._t),
          _dist(_graph) {}
...
public:
  ...
  template <typename T> struct SetPotentialMapTraits : public Traits {
  ...
  template <typename H, typename CR> struct SetHeapTraits : public Traits {
    typedef H Heap;
...
public:
  ...
  Suurballe(const Digraph &graph, const LengthMap &length)
      : _graph(graph), _length(length), _flow(0), _local_flow(false),
        _potential(0), _local_potential(false), _pred(graph), _init_dist(0),
        _init_pred(0) {}
