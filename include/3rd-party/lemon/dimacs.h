...
template <typename Digraph, typename LowerMap, typename CapacityMap,
          typename CostMap, typename SupplyMap>
void readDimacsMin(std::istream &is, Digraph &g, LowerMap &lower,
...
void _readDimacs(std::istream &is, Digraph &g, CapacityMap &capacity,
...
void readDimacsSp(std::istream &is, Digraph &g, LengthMap &length,
...
/// the descriptor struct should be given by the \c dest parameter.
template <typename Digraph, typename CapacityMap>
void readDimacsCap(std::istream &is, Digraph &g, CapacityMap &capacity,
                   typename CapacityMap::Value infty = 0,
                   DimacsDescriptor desc = DimacsDescriptor()) {
