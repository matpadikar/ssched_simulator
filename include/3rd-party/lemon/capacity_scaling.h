...
public:
  ...
  template <typename T> struct SetHeapTraits : public Traits {
    typedef T Heap;
  };
...
public:
  ...
  ///
  /// \return <tt>(*this)</tt>
  template <typename LowerMap> CapacityScaling &lowerMap(const LowerMap &map) {
    _has_lower = true;
  ...
  ///
  /// \return <tt>(*this)</tt>
  template <typename UpperMap> CapacityScaling &upperMap(const UpperMap &map) {
    for (ArcIt a(_graph); a != INVALID; ++a) {
  ...
  ///
  /// \return <tt>(*this)</tt>
  template <typename CostMap> CapacityScaling &costMap(const CostMap &map) {
    for (ArcIt a(_graph); a != INVALID; ++a) {
